                            ...
                            <div class="content">
                                <div class="row row-same-height">
                                    <div class="col-sm-4 col-md-2 text-center-xs">
                                        <img class="profile-header-avatar img-responsive" style="border: 4px solid #F5F5F6; margin-top: -60px" alt="" src="{{asset('storage/business_images/'.Auth::user()->name.'/'.Auth::user()->profile_picture.'' )}}" />
                                    </div>

                                    <div class="col-sm-8 col-md-5 text-center-xs">
                                        <p>
                                            <span class="label label-defaultbusiness-tag" style="background: #f27684">BUSINESS</span>
                                        </p>
...
{{--                                        </p>--}}
                                         ...
                                         <span class="category-ribbon">
                                            <p class="edit-avatar-hover">
                                                <i class="edit-avatar-hover fa fa-heart-o"></i> {{ Auth::user()->category->name }}
                                            </p>
                                        </span>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-offset-1 col-sm-11">
                                                ...
                                                <h4 style="margin-bottom: 5px;">
                                                    ...
                                                    <a href="" class="edit-avatar-hover">
                                                        &nbsp;
                                                    </a>
                                                </h4>
                                                ...
                                                <h4 style="margin-bottom: 5px;">
                                                    <i class="edit-avatar-hover fa fa-book"></i>  Description:
                                                </h4>
                                        ...
                                        <div class="panel-body" style="min-height: 300px;">
                                            <div class="post_topbar">
                                                <div class="usy-dt">
                                                    ...
                                                    <img style="position: relative;bottom: 3px;right: 23px;" width="40" height="40" src="{{asset('storage/business_images/'.Auth::user()->name.'/'.Auth::user()->profile_picture.'' )}}" alt="">
                                                    <div class="usy-name">
