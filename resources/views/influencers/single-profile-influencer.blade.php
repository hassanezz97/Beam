                            ...
                            <div class="content">
                                <div class="row row-same-height">
                                    <div class="col-sm-4 col-md-2 text-center-xs">
                                        <img class="profile-header-avatar img-responsive" style="border: 4px solid #F5F5F6; margin-top: -60px" alt="" src="{{asset('storage/influencer_images/'.$influencers->name.'/'.$influencers->profile_picture.'' )}}" />
                                    </div>
                                    ...
                                    <div class="col-sm-8 col-md-5 text-center-xs">
                                        ...
                                        <span class="category-ribbon">
                                            <p class="edit-avatar-hover"><i class="edit-avatar-hover fa fa-heart-o"></i> {{$influencers->category->name}}</p>
                                        </span>
                                            ...
                                            <div class="col-sm-offset-1 col-sm-11">
                                                ...
                                                <ul class="list-unstyled networks">
                                                    <li class="network" id="influence-profile-link" style="margin-left: 20px;">
                                                        ...
                                                        <a target="blank" href="https://www.instagram.com/{{$influencers->instagram_username}}" class="edit-avatar-hover">{{$influencers->instagram_username}}</a>
                                                    </li>
                                                </ul>
