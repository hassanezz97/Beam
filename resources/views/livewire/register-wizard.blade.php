...
{{--                </div>--}}
            ...
            <div class="bs-stepper-content">
                <form >
                    ...
                    {{---------------------------------Email Verification-----------------------------}}
                    @include('auth.registration-steps-influencer.email-verification-s4')
                    {{---------------------------------Personal Information-----------------------------}}
                    @include('auth.registration-steps-influencer.personal-information-s2')
                    {{---------------------------------Profile Detailsaccount-details-s1.blade.php-----------------------------}}
                    @include('auth.registration-steps-influencer.profile-details-s3')
                </form>
            </div>
        </div>
    </div>
